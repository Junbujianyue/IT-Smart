...
namespace NBD3.Models
{
    public class Client
    {
        ...
        [RegularExpression(@"^\d{3}-\d{3}-\d{4}$", ErrorMessage = "Please enter a valid phone number in the format '222-222-2222'.")]
        ...
        [RegularExpression("^[a-zA-Z'-]*$", ErrorMessage = "City can only contain letters, apostrophes, and hyphens.")]
